...
var getEtpWeightList = function(req, res) {
  try {
    ...
    paramData.arr_not_in_F16316 = [{
      "F16316": "CASH00000001"
    }]; //  설정현금액(CASH00000001) 제외
    var stmt = mapper.getStatement('etpDetail', 'getEtpWeightList', paramData, {
      language: 'sql',
      indent: ' '
    });
    // log.debug(stmt, paramData);
...
var getEtpMultiFactor = function(req, res) {
  try {
    ...
    var mapper = req.app.get("mapper");
    var paramData = req.query;
    var stmt = mapper.getStatement('etpDetail', 'getEtpMultiFactor', paramData, {
      language: 'sql',
      indent: ' '
    });
    // log.debug(stmt, paramData);
...
var getEtpFundFlowRank = function(req, res) {
  try {
    ...
    var paramData = req.query;
    var stmt = mapper.getStatement('etpDetail', 'getEtpFundFlowRank', paramData, {
      language: 'sql',
      indent: ' '
    });
    // log.debug(stmt, paramData);
