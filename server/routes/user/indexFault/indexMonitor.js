...
var getHoliday = function(req, res) {
  console.log('indexMonitor 모듈 안에 있는 getHoliday 호출됨.');

  var pool = req.app.get("pool");
  var mapper = req.app.get("mapper");
  var paramData = req.query;
  // console.log(paramData);
  var stmt = mapper.getStatement('indexMonitor', 'selectHoliday', paramData, mconfig.format);
  // console.log(stmt);
...
var getHolidayAll = function(req, res) {
  console.log('indexMonitor 모듈 안에 있는 getHoliday 호출됨.');

  var pool = req.app.get("pool");
  var mapper = req.app.get("mapper");
  // var paramData = req.query;
  var stmt = mapper.getStatement('indexMonitor', 'selectHolidayAll', {}, mconfig.format);
  console.log(stmt);
...
module.exports.getHolidayAll = getHolidayAll;
