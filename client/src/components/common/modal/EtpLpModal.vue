      ...
      <v-card flat ma-3>
        ...
        <div class="graph_01_w">
          <div class="sub_title_num">
            ...
            <span
              :style="etpInfo.F15472_Style"
            >{{formatInt(etpInfo.F15472)}}({{etpInfo.F15004}}%)</span>
            <!--
            ...
            <v-layout>
              ...
              <v-flex>
                <ul>
                  ...
                  <li class="number2">
                    <span :style="etpInfo.F30818_Style">{{etpInfo.F30818}}%</span>
                  </li>
                </ul>
              </v-flex>
              <v-flex>
                <ul>
                  ...
                  <li class="number2">
                    <span :style="etpInfo.F30823_Style">{{etpInfo.F30823}}%</span>
                  </li>
                </ul>
              </v-flex>
              <v-flex>
