    ...
    mounted: function() {
      ...
      publish_etp_table = $('#publish_etp_table').DataTable({
        ...
        columns: [{
          ...
          "orderable": false,
          width: '5%',
          defaultContent: "<button type='button' id='btn_faver' class='btn_icon v-icon material-icons'>star</button>"
        }, {
          "data": "JISU_NM",
          "orderable": false,
          width: '65%',
          className: 'txt_left line2 in_icon'
        }, {
          "data": "F15001",
          "orderable": false,
          width: '30%',
