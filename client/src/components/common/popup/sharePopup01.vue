                ...
                <div class="incode_pop">
                    ...
                    <div class="table-box" style="height:200px;">
                      <table class="tbl_type ver8 v2">
                        ...
                        <tbody>
                          ...
                          >
                            <td class="txt_left" colspan="3">공유자 내역이 없습니다.</td>
                          </tr>
                  ...
                  <div class="text-xs-center">
                    <v-btn
                      ...
                      small
                      color="primary"
                      @click.stop="fn_apply_share_user_in_arr()"
                    >공유하기</v-btn>
                  </div>
                </div>
    ...
    methods: {
      ...
      async fn_apply_share_user_in_arr() {
        ...
        if(!temp || temp.length == 0) {
          if(await vm.$root.confirmt.open('확인', '공유할 대상자가 1건 이상 선택되어야 합니다.', {}, 1)) {}
          return false;
        }
      ...
      async fn_apply_share_user_revoke_in_arr(p_checkedItem) {
        ...
        if(!p_checkedItem || !p_checkedItem.email) {
          if(await vm.$root.confirmt.open('확인', '공유해제할 대상자가 선택되어야 합니다.', {}, 1)) {}
          return false;
        }
        return await new Promise(async function(resolve, reject) {
