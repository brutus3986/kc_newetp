  ...
  export default {
    ...
    mounted() {
      ...
      if(this.dragAndDropCapable) {
        ...
        ["drag", "dragstart", "dragend", "dragover", "dragenter", "dragleave", "drop"].forEach(function(evt) {
          this.$refs.methodForm.addEventListener(evt, function(e) {
            e.preventDefault();
            e.stopPropagation();
          }.bind(this), false);
        }.bind(this));
        ...
        /* 지수방법론 파일 영역 */
        this.$refs.methodForm.addEventListener("drop", function(e) {
          var selfThis = this;
      ...
      /* 지수방법론 파일 영역 */
      this.$refs.methodFile.addEventListener("change", function(evt) {
        var selfThis = this;
