    ...
    <v-layout row wrap class="content_margin etp_new">
      <v-flex grow>
                  ...
                  <v-flex xs4 sm6 md4>
                    ...
                    >
                      ...
                      <v-date-picker
                        ...
                        v-model="masterData.list_req_date"
                        locale="ko"
                        @input="$refs.menu.save(masterData.list_req_date)"
                      ></v-date-picker>
                    </v-menu>
                  </v-flex>
                </v-layout>
                  ...
                  <v-flex xs4 sm6 md4>
                    ...
                    >
                      ...
                      <v-date-picker
                        ...
                        v-model="masterData.list_date"
                        locale="ko"
                        @input="$refs.menu2.save(masterData.list_date)"
                      ></v-date-picker>
                    </v-menu>
                  </v-flex>
                </v-layout>
              ...
              <v-layout>
                ...
                <v-flex xs8>
                  <v-text-field
                    ...
                    value
                    outline
                    v-model="masterData.idx_file_nm"
                    maxlength="30"
                    ref="idx_file_nm"
              ...
              <v-layout>
                ...
                <v-flex xs8>
                  <v-text-field
                    ...
                    value
                    outline
                    v-model="masterData.idx_file_path"
                    maxlength="500"
                    ref="idx_file_path"
              ...
              <v-layout row>
                ...
                <v-flex xs5 row class="checkbox_w">
                  <v-layout row wrap class="light--text">
                    <v-flex xs2>
                      <v-checkbox
                        v-bind:disabled="idxCompDistYn === 'N' || inputDisabled"
                        color="primary"
              ...
              <v-layout row>
                ...
                <v-flex xs3>
                  <v-text-field
                    ...
                    value
                    outline
                    v-model="masterData.blom_ticker"
                    v-bind:disabled="inputDisabled"
                    maxlength="15"
                  ></v-text-field>
                </v-flex>
              ...
              <v-layout row>
                ...
                <v-flex xs3>
                  <v-text-field
                    ...
                    label="지수심볼"
                    outline
                    v-model="masterData.kor_idx_sym_code"
                    ref="kor_idx_sym_code"
              ...
              <v-layout>
                ...
                <v-flex xs8>
                  <v-textarea
                    ...
                    outline
                    color="blue"
                    v-model="masterData.kor_user_req"
                    maxlength="500"
                    ref="kor_user_req"
            ...
            <v-layout row>
              ...
              <v-flex xs3>
                <v-text-field
                  ...
                  value
                  outline
                  v-model="masterData.ridx_dist_sym_code"
                  maxlength="16"
                ></v-text-field>
              </v-flex>
            </v-layout>
        ...
        >
          ...
          <v-container fluid>
            <v-layout row>
              ...
              <v-flex xs3>
                <v-text-field
                  v-bind:disabled="masterData.etp_type !== 'ETF' || inputDisabled"
                  label
                  value
                  outline
                  v-model="masterData.refidx_sym_code"
                ></v-text-field>
              </v-flex>
              <v-flex xs2>
                <v-subheader class="subheader_r">지수명칭</v-subheader>
            ...
            <v-layout row>
              ...
              <v-flex xs3>
                <v-text-field
                  ...
                  value
                  outline
                  v-model="masterData.refidx_file_nm"
                  maxlength="30"
                ></v-text-field>
              </v-flex>
            </v-layout>
            ...
            <v-layout row>
              ...
              <v-flex xs8>
                <v-text-field
                  ...
                  value
                  outline
                  v-model="masterData.refidx_blom_ticker"
                ></v-text-field>
              </v-flex>
            </v-layout>
          </v-container>
        ...
        <v-card class="register_wrap" color="lighten-1" flat xs12>
          ...
          <div
            class="text-xs-center pt-3 mt-3"
            v-if="masterData.paramInstTypeCd !==koscomSuperUser && masterData.paramInstTypeCd !==koscomUser "
          >
            <v-btn
              color="primary"
              depressed
              dark
              v-if="masterData.seq  === ''&& !inputDisabled"
              @click.prevent="fn_insertEtpRegister('S')"
            >저장</v-btn>
            <v-btn
              color="primary"
              depressed
              dark
              v-if="masterData.seq  !== ''&& !inputDisabled"
              @click.prevent="fn_insertEtpRegister('U')"
            >수정</v-btn>
          </div>
        </v-card>
            ...
            <v-layout row>
              ...
              <v-flex xs3>
                <v-text-field
                  ...
                  value
                  outline
                  v-model="masterData.real_idx_tr"
                  maxlength="50"
                ></v-text-field>
              </v-flex>
            </v-layout>
            ...
            <v-layout row>
              ...
              <v-flex xs3>
                <v-text-field
                  ...
                  value
                  outline
                  v-model="masterData.krx_up_code"
                  maxlength="5"
                  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                ></v-text-field>
              </v-flex>
              ...
              <v-flex xs3>
                <v-text-field
                  ...
                  value
                  outline
                  v-model="masterData.agent_up_code"
                  maxlength="5"
                  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                ></v-text-field>
              </v-flex>
  ...
  export default {
    data() {
      return {
        ...
        errors: {
          ...
          idx_sym_code: true,
          idx_nm: true,
          idx_dist_inst_cd: true,
          idx_close_type: true,
          idx_holy_cd: true,
          idx_trace_yd_mult_type: true,
          pre_idx_type: true,
          idx_file_nm: true,
          idx_comp_ksd_dist_yn: true,
          idx_comp_mirae_dist_yn: true,
          blom_ticker: true,
          user_req: true,
          real_yn: "N",
          ridx_inst_cd: true,
          ridx_dist_inst_cd: true,
          ridx_crt_sym_code: true,
          ridx_dist_sym_code: true,
          ridx_holy_cd: true,
          ridx_krx_dist_yn: true,
          ridx_comp_dist_yn: true,
          ridx_ksd_dist_yn: true,
          ridx_mirae_dist_yn: true,
          ridx_dist_term: true,
          refidx_sym_code: true,
          refidx_nm: true,
          refidx_inst_cd: true,
          refidx_file_nm: true,
          refidx_req: true,
          refidx_blom_ticker: true,
          ex_rate_cd: true,
          ex_hedge_yn: true,
          isin_stat_cd: true,
          inav_calc_cd: true,
    ...
    methods: {
      ...
      getEtpRegisterView: function() {
        ...
        axios.get(Config.base_url + "/user/etp/getEtpRegisterView", {
          params: {
            seq: vm.seq
          }
          ...
          if(!response.data.result) {
            ...
            vm.masterData = {
              ...
              pre_idx_type: "",
              idx_file_nm: "",
              idx_comp_ksd_dist_yn: "",
              idx_comp_mirae_dist_yn: "",
              blom_ticker: "",
              user_req: "",
              real_yn: "N",
              ridx_inst_cd: "",
            ...
            for(let i = 0; i < code004List.length; i++) {
              vm.code004List.push({
                value: code004List[i].M_CD,
                text: code004List[i].M_CD_NM
              });
            }
            ...
            for(let i = 0; i < code005List.length; i++) {
              vm.code005List.push({
                value: code005List[i].M_CD,
                text: code005List[i].M_CD_NM
              });
            }
            ...
            for(let i = 0; i < code006List.length; i++) {
              vm.code006List.push({
                value: code006List[i].M_CD,
                text: code006List[i].M_CD_NM
              });
            }
            ...
            for(let i = 0; i < code007List.length; i++) {
              vm.code007List.push({
                value: code007List[i].M_CD,
                text: code007List[i].M_CD_NM
              });
            }
            ...
            for(let i = 0; i < code008List.length; i++) {
              vm.code008List.push({
                value: code008List[i].M_CD,
                text: code008List[i].M_CD_NM
              });
            }
            ...
            for(let i = 0; i < code009List.length; i++) {
              vm.code009List.push({
                value: code009List[i].M_CD,
                text: code009List[i].M_CD_NM
              });
            }
            ...
            for(let i = 0; i < code010List.length; i++) {
              vm.code010List.push({
                value: code010List[i].M_CD,
                text: code010List[i].M_CD_NM
              });
            }
            ...
            if(response.data.masterData.length > 0) {
              ...
              if((paramData.inst_cd !== vm.masterData.inst_cd) && (paramData.inst_type_cd !== vm.koscomUser && paramData.inst_type_cd !== vm.koscomSuperUser)) {
      ...
      fn_insertEtpRegister: async function(arg) {
        ...
        if(arg === 'S' && hudleYn == 'Y') {
          ...
          if(await this.$root.confirmt.open("[저장]", "저장하시겠습니까?", {}, 2)) {
          ...
          await axios({
            ...
            data: {
              "data": JSON.stringify(vm.masterData, replacer)
            },
            headers: {
            ...
            if(response.data.result) {
              if(vm.$root.confirmt.open('[저장]', '저장이 완료되었습니다.', {}, 1)) {
                if("Y" == vm.$root.confirmt.val) {
                  vm.$emit("movePage", 0);
                }
              }
          ...
          if(vm.masterData.isin_stat_cd == '0002' && vm.masterData.idx_rec_yn == 'N') {
            if(await this.$root.confirmt.open('[저장]', '기초지수입수여부가 "N"으로 변경되어 종목신청상태로 돌아갑니다.', {}, 2)) {
              if("Y" != this.$root.confirmt.val) {
                return false;
              }
            }
          }
          if(await this.$root.confirmt.open('[수정]', '수정하시겠습니까', {}, 2)) {
            if("Y" != this.$root.confirmt.val) {
              return false;
            }
          }
          ...
          await axios({
            ...
            if(response.data.result) {
              if(vm.$root.confirmt.open('[수정]', '수정이 완료되었습니다.', {}, 1)) {
                if("Y" == vm.$root.confirmt.val) {
                  vm.$emit("movePage", 0);
                }
              }
