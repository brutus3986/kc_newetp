  ...
  <v-container>
    <v-layout row wrap class="content_margin">
      <v-flex grow>
        <v-card flat>
          <v-card-title primary-title>
            <h3 class="headline mb-0">
              ETP 신청현황 |
              <span class="grey--text">코스콤에 신청하신 ETP목록 및 ETP별 진행 상태를 확인 할 수 있습니다.</span>
            </h3>
          </v-card-title>
        </v-card>
        <v-card flat>
        ...
        <!-- 회사 연락처 팝업 -->
        <companyContactModal
          :companyContactModal="this.companyContactModal"
          @close="hideContactkPop"
        ></companyContactModal>
        <!-- 회사 연락처 팝업   end  -->
        <!-- 기초지수 팝업 내용 -->
            ...
            this.list_cnt = this.results.length;
             table = $("#example1").DataTable({
              ...
              columns: [{
                ...
                "data": "ridx_dist_sym_code",
                "orderable": false
              }, {
                "data": "inst_nm",
                "orderable": true,
                className: "txt_left t_link"
              }, {
                "data": "isu_kor_nm",
                "orderable": true,
                className: "txt_left t_link"
