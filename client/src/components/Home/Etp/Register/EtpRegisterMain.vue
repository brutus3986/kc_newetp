<template>
  <v-layout row wrap>
    <v-flex xs12>
      ...
      <EtpApplyList v-show="tabs==0" @moveUpdatePage="moveUpdatePage" :seq="seq" ref="list"></EtpApplyList>
      <EtpRegister v-show="tabs==1" @movePage="movePage()" :seq="seq" ref="form"></EtpRegister>
    </v-flex>
  </v-layout>
</template>
