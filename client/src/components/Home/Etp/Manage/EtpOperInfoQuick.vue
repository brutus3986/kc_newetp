              ...
              <v-list>
                ...
                >
                  <v-list-tile-avatar>
                    ...
                    <div :class="( toggleINav ? 'oper_list_icon select' : 'oper_list_icon' )">
                ...
                >
                  <v-list-tile-avatar>
                    <div
                      :class="( toggleEtpPerformance ? 'oper_list_icon select' : 'oper_list_icon' )"
                    >
                ...
                >
                  ...
                  <v-list-tile-avatar>
                    <div
                      :class="( toggleEtpLpspread ? 'oper_list_icon select' : 'oper_list_icon' )"
                    >
                ...
                <v-dialog v-model="customizeDialog" persistent max-width="650">
                  <template v-slot:activator="{ on }">
                    <v-list-tile
                      v-on="on"
                      @click="toggleCustomize=true;toggleINav=false;toggleEtpPerformance=false;toggleEtpLpspread=false;"
                      :class="( toggleCustomize ? 'border_b select' : 'border_b' )"
                    >
                      <v-list-tile-avatar>
                        <div
                          :class="( toggleCustomize ? 'oper_list_icon select' : 'oper_list_icon' )"
                        >
