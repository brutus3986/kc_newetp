          ...
          <v-card flat class="indexinfo_list_table">
            ...
            <v-layout row>
              ...
              <v-flex
                xs6
                class="text_r"
              >{{ new Intl.NumberFormat().format( etpBasic.F15028 ) /* 시가총액 */ }}</v-flex>
            </v-layout>
            <v-layout row>
              ...
              <v-flex
                xs6
                class="text_r"
              >{{ ["3", "4"].includes( etpBasic.F16493 ) ? "N/A" : new Intl.NumberFormat().format( etpBasic.F34515 ) /* ETF_1CU당금액 */ }}</v-flex>
            </v-layout>
            <v-layout row>
              ...
              <v-flex
                xs6
                class="text_r"
              >{{ ["3", "4"].includes( etpBasic.F16493 ) ? "N/A" : new Intl.NumberFormat().format( etpBasic.F16499 ) /* ETF_CU구성단위 */ }}</v-flex>
            </v-layout>
            <v-layout row>
              ...
              <v-flex
                xs6
                class="text_r"
              >{{ new Intl.NumberFormat().format( etpBasic.F16143 ) /* 상장 주식수 */ }}</v-flex>
            </v-layout>
            <v-layout row>
              ...
              <v-flex
                xs6
                class="text_r"
              >{{ new Intl.NumberFormat().format( etpBasic.F15015 ) /* 거래량 */ }}</v-flex>
            </v-layout>
            <v-layout row>
              ...
              <v-flex
                xs6
                class="text_r"
              >{{ new Intl.NumberFormat().format( etpBasic.F15007 ) /* 기준가 */ }}</v-flex>
            </v-layout>
          </v-card>
        </div>
      </v-flex>
          ...
          <v-card flat class="indexinfo_list_table">
            ...
            <v-layout row>
              ...
              <v-flex
                xs7
                class="text_r"
              >{{ new Intl.NumberFormat().format( indexBasic.std_index ) /* 지수산출방식 */ }}</v-flex>
            </v-layout>
            <v-layout row>
              ...
              <v-card flat class="indexinfo_list_table" style="padding-right:24px;">
                <v-layout row>
                  ...
                  <v-flex
                    xs6
                    class="text_r"
                  >{{ new Intl.NumberFormat().format( etpBasic.F03329 ) /* 전일ETP지표가치(예탁원)(NAV/IV) */ }}</v-flex>
                </v-layout>
                <v-layout row>
                  ...
                  <v-flex xs6 class="text_r">
                    ...
                    <br />
                    <span
                      :class="etpBasic.F30818 >= 0 ? 'text_red' : 'text_blue' "
                    >{{ etpBasic.F30818 /* 장중지표가치(iNAV/iIV)등락율 */ }}%</span>
                  </v-flex>
                </v-layout>
                <v-layout row>
              ...
              <v-card flat class="indexinfo_list_table">
                <v-layout row>
                  ...
                  <v-flex
                    xs6
                    class="text_r"
                  >{{ new Intl.NumberFormat().format( Number( etpBasic.F15318 ) - Number( etpBasic.F15319 ) ) /* ETP기초지수현재가 - ETP기초지수기준대비 */ }}</v-flex>
                </v-layout>
                <v-layout row>
                  ...
                  <v-flex xs6 class="text_r">
                    ...
                    <br />
                    <span
                      :class="etpBasic.F30823 >= 0 ? 'text_red' : 'text_blue' "
                    >{{ etpBasic.F30823 /* ETF관련지수등락율 */ }}%</span>
                  </v-flex>
                </v-layout>
              </v-card>
            </v-flex>
  ...
  export default {
    ...
    computed: {
      fn_indexExistsYn: function() {
        var vm = this;
        if(typeof vm.indexBasic === "undefined" || vm.indexBasic.length == 0) {
          return false;
        }
        return true;
      }
