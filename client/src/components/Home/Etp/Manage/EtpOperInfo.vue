    ...
    mounted: function() {
      ...
      new Promise(function(resolve, reject) {
        ...
        vm.fn_setArrShowColumn([
          'F16002' /* 종목 */ , 'W00002' /* 종가1주수익률 */ , 'W00003' /* 종가1달수익률 */ , 'W00004' /* 종가3달수익률 */ , 'W00005' /* 종가YTD수익률 */ , 
          'W00012' /* NAV1주수익률 */ , 'W00013' /* NAV1달수익률 */ , 'W00014' /* NAV3달수익률 */ , 'W00015' /* NAVYTD수익률 */ , 'graph' /* 그래프 영역 */ ]);
    ...
    methods: {
      ...
      fn_setTableInfo(arrCustomizeColumn) {
        ...
        if(vm.stateInfo.pageState == "etpInfo") {
          vm.fn_setArrShowColumn([
            'F16002' /* 종목 */ , 'F15301' /* iNAV */ , 'F03329' /* 전일최종NAV */ , 'F19329' /* 전일추적오차율 */ , 'F19330' /* 전일괴리율 */ , 
            'F34777' /* 기초지수 */ , 'F15318' /* 지수현재가 */ , 'graph' /* 그래프 영역 */ ]);
        }
        /* [iNAV 산출현황] 을 선택한 경우 */
        else if(vm.stateInfo.pageState == "iNav") {
          vm.fn_setArrShowColumn([
            'F16002' /* 종목 */ , 'F33929_nm' /* 산출방식 */ , 'F15301' /* iNAV */ , 'F03329' /* 전일최종NAV */ , 'F34777' /* 기초지수 */ , 
            'F15318' /* 지수현재가 */ , 'F18450' /* 환코드 */ , 'F18438' /* 환율 */ , 'graph' /* 그래프 영역 */ ]);
        }
        /* [LP spread] 을 선택한 경우 */
        else if(vm.stateInfo.pageState == "lpspread") {
          vm.fn_setArrShowColumn([
            'F16002' /* 종목 */ , 'F15301' /* iNAV */ , 'F15318' /* 지수현재가 */ , 'F40544' /* LP매도호가1 */ , 'F40545' /* LP매수호가1 */ , 
            'F33294' /* LP스프레드 */ , 'graph' /* 그래프 영역 */ ]);
        }
        /* customize 를 선택한 경우 */
      ...
      fn_setArrShowColumn(arrTemp) {
        ...
        var arrColumn = [
          ...
          // { /* 순자산총액(백만)  */'name' : 'F18001'             , 'data': 'F18001'           ,  'width' : '80',  'orderable' : true  , 'className': 'txt_right', 'title' : '순자산총액(원)'},      /* 순자산총액(원)  */
          {
            'name': 'F16012',
            'data': 'F16012',
            'width': '80',
          ...
          /* 그래프 */
          {
            ...
            "render": function(data, type, row, meta) {
              ...
              if(vm.stateInfo.pageState === 'iNav') {
                if((typeCd == "9998" || typeCd == "9999") || krxCd == row.F33960 /* 로그인 운용사 코드와 해당 row의 ETP운용사코드 가 같은 경우 */ ) {
      ...
      fn_downExcel: function() {
        ...
        if(vm.stateInfo.pageState == "etpInfo") {
          sheetNm = "ETP 운용정보";
          arrHeaderNm = ["종목", "단축코드", "iNAV", "iNAV 등락율", "전일NAV", "TE", "괴리율", "기초지수", "지수", "지수 등락율"];
          arrHeaderKey = ["F16002", "F16013", "F15301", "F30818", "F03329", "F19329", "F19330", "F34777", "F15318", "F30823"];
          arrColsInfo = [{width: 30}, {width: 10}, {width: 15}, {width: 15}, {width: 15}, {width: 15}, {width: 15}, {width: 30}, {width: 15}, {width: 15}];
          /* [iNAV]를 선택하는 경우 */
        } else if(vm.stateInfo.pageState == "iNav") {
          sheetNm = "iNav 산출현황";
          arrHeaderNm = ["종목", "단축코드", "산출방식", "iNAV", "iNAV 등락율", "전일NAV", "기초지수", "지수", "지수 등락율", "환코드", "환율 (매매기준율)", "환율 (장전 대비 매매기준율)"];
          arrHeaderKey = ["F16002", "F16013", "F33929_nm", "F15301", "F30818", "F03329", "F34777", "F15318", "F30823", "F18450", "F30819", "F18438"];
          arrColsInfo = [{width: 30}, {width: 10}, {width: 15}, {width: 15}, {width: 15}, {width: 15}, {width: 30}, {width: 15}, {width: 15}, {width: 15}, {width: 15}, {width: 20}];
          /* [Performance]를 선택하는 경우 */
        } else if(vm.stateInfo.pageState == "performance") {
          sheetNm = "performance";
          arrHeaderNm = ["종목", "단축코드", "수익율(증가) 1주", "수익율(증가) 1개월", "수익율(증가) 3개월", "수익율(증가) YTD", "수익율(NAV) 1주", "수익율(NAV) 1개월", "수익율(NAV) 3개월", "수익율(NAV) YTD"];
          arrHeaderKey = ["F16002", "F16013", "W00002", "W00003", "W00004", "W00005", "W00012", "W00013", "W00014", "W00015"];
          arrColsInfo = [{width: 30}, {width: 10}, {width: 20}, {width: 20}, {width: 20}, {width: 20}, {width: 20}, {width: 20}, {width: 20}, {width: 20}];
          /* [LP Spread]를 선택하는 경우 */
        } else if(vm.stateInfo.pageState == "lpspread") {
          sheetNm = "LP spread";
          arrHeaderNm = ["종목", "단축코드", "iNAV", "iNAV 등락율", "지수", "지수 등락율", "LP매도호가", "LP매수호가", "LP스프레드"];
          arrHeaderKey = ["F16002", "F16013", "F15301", "F30818", "F15318", "F30823", "F40544", "F40545", "F33294"];
          arrColsInfo = [{width: 30}, {width: 10}, {width: 15}, {width: 15}, {width: 15}, {width: 15}, {width: 20}, {width: 15}, {width: 15}];
          /* [customize]를 선택하는 경우 */
        } else if(vm.stateInfo.pageState == "customize") {
          sheetNm = "customize";
          arrHeaderNm = [];
