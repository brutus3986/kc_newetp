      ...
      getEtpFundFlowRank: function(val, gubun) {
        ...
        axios.get(Config.base_url + "/user/etp/getEtpFundFlowRank", {
          ...
          if(response.data.success == false) {
            ...
            vm.citem[gubun] = (typeof mRes[tmp] == "undefined" ? {
              FLOW: ""
            } : mRes[tmp]);
            vm.rank[gubun] = tmp + 1;
            vm.num[gubun] = resLen;
