...
//            vm.etpBasic     =   dataList[0];
  ...
  fn_setArrShowColumn(arrTemp) {
    ...
    var arrColumn  =   [
      ...
      { 'name' : 'F19329'             , 'data': 'F19329'           ,  'width' : '50',  'orderable' : true  , 'className': 'txt_right', 'title' : '추적오차율'},      /* 추적오차율 */
      ...
      { 'name' : 'F15007'             , 'data': 'F15007'           ,  'width' : '80',  'orderable' : true  , 'className': 'txt_right', 'title' : '기준가'},      /* 기준가  */
      { 'name' : 'F15001'             , 'data': 'F15001'           ,  'width' : '80',  'orderable' : true  , 'className': 'txt_right', 'title' : 'ETF 현재가'},      /* 현재가  */
      { 'name' : 'F16073'             , 'data': 'F16073'           ,  'width' : '80',  'orderable' : true  , 'className': 'txt_right', 'title' : '락구분코드'},      /* 락구분코드  */

      { 'name' : 'F16500'             , 'data': 'F16500'           ,  'width' : '80',  'orderable' : true  , 'className': 'txt_right', 'title' : '순자산총액(백만)'},      /* 순자산총액(백만)  */
      // { 'name' : 'F18001'             , 'data': 'F18001'           ,  'width' : '80',  'orderable' : true  , 'className': 'txt_right', 'title' : '순자산총액(원)'},      /* 순자산총액(원)  */
      { 'name' : 'F16012'             , 'data': 'F16012'           ,  'width' : '80',  'orderable' : true  , 'className': 'txt_right', 'title' : '국제표준코드'},
      { 'name' : 'F16017'             , 'data': 'F16017'           ,  'width' : '80',  'orderable' : true  , 'className': 'txt_right', 'title' : '상장일'},
      { 'name' : 'F34514'             , 'data': 'F34514'           ,  'width' : '80',  'orderable' : true  , 'className': 'txt_right', 'title' : '복제방법'},
