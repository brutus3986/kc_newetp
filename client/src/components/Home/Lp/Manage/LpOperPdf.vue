...
<script>
  ...
  import LpOperPdfQuick from "@/components/Home/Lp/Manage/LpOperPdfQuick.vue";
  var tblPdfList = null;
  export default {
    ...
    methods: {
      ...
      fn_setTableInfo(arrCustomizeColumn) {
        ...
        if(vm.stateInfo.pageState == "pdf") {
          vm.fn_setArrShowColumn([
            "fmt_F12506" /* 입회일 - Date */ , "status" /* 상태 */ , "F33861" /* ETF시장구분 - 시장구분 -  */ , "F16316" /* 구성종목코드 - 종목코드 */ , "F16004" /* 해외시장종목명 - 종목명 */ , 
            "F16499" /* 1CU단위증권수 - CU SHrs */ , "F34840" /* 액면금액설정현금액 - 액면금액 */ , "F16588" /* 평가금액 - 평가금액 */ , "fmt_F34743" /* ETF_PDF비중 - 비중 */ ]);
        }
        /* [비중변경현황] 을 선택한 경우 */
        else if(vm.stateInfo.pageState == "pdfByRate") {
          vm.fn_setArrShowColumn([
            "fmt_F12506" /* 입회일 - Date */ , , "status" /* 상태 */ , "F33861" /* ETF시장구분 - 시장구분 */ , , 
            "F16316" /* 구성종목코드 - 종목코드 */ , , "F16004" /* 해외시장종목명 - 종목명 */ , , "F16499" /* 1CU단위증권수 - CU SHrs */ , , 
            "F34840" /* 액면금액설정현금액 - 액면금액 */ , , "F16588" /* 평가금액 - 평가금액 */ , , 
            "rate_day0" /* 비중 당일 */ , , "rate_day1" /* 비중 1일전 */ , , "rate_day2" /* 비중 2일전 */ , , "rate_day3" /* 비중 3일전 */ , , "rate_day4" /* 비중 4일전 */ , ]);
        }
      ...
      fn_downExcel: function() {
        ...
        if(vm.stateInfo.pageState == "pdfByRate") {
          ...
          arrColsInfo = [
            {width: 15}, {width: 10}, {width: 10}, {width: 15}, {width: 30}, 
