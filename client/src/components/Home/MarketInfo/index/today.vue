      ...
      <v-flex grow xs12 mt-2>
        <v-card flat>
          <v-card-title primary-title class="tbl_w2">
            <v-list-tile>
              <v-list-tile-title class="headline">KRX</v-list-tile-title>
            </v-list-tile>
          </v-card-title>
          <v-card flat>
            ...
            <v-btn block color="#ffffff" @click="moreData('krx')">
              <v-icon color="#9e9e9e">add</v-icon>
              더보기 ({{krxCurrentPage}}/{{krxTotalPage}})
            </v-btn>
          </v-card>
        </v-card>
      </v-flex>
        ...
        <v-card flat>
          <v-card-title primary-title class="tbl_w2">
            <v-list-tile>
              ...
              <v-list-tile-content>
                <v-list-tile-title class="headline">FnGuide</v-list-tile-title>
