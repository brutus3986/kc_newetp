  ...
  <v-layout row wrap class="content_margin con_wrap">
    <v-flex grow :class="className">
      ...
      <v-dialog v-model="showEtpInfoPdfDetail" persistent max-width="1100">
        <EtpInfoPdfDetail
          v-if="showEtpInfoPdfDetail"
          :showEtpInfoPdfDetail="showEtpInfoPdfDetail"
          :paramData="paramData"
...
<script>
  ...
  export default {
    ...
    components: {
      ...
      /* PDF 상세 */
      EtpInfoPdfDetail: EtpInfoPdfDetail,
      /* PDF 수정내역 팝업 */
      EtpOperPdfHistPop: EtpOperPdfHistPop,
      /* 001-시장대표 */
      marketRepresent: marketRepresent,
      /* 002-섹터*/
      marketSector: marketSector,
      /* 003-테마 */
      marketThema: marketThema,
      /* 004-전략 */
      marketStrategy: marketStrategy,
      /* 005-채권 */
      marketBond: marketBond,
      /* 006-통화 */
      marketCurrency: marketCurrency,
      /* 007-원자재 */
      marketRawMaterials: marketRawMaterials,
      /* 008-VIX */
      marketVix: marketVix,
      /* 009-부동산 */
      marketRealEstate: marketRealEstate,
      /* 010-혼합자산 */
      marketMixAssets: marketMixAssets,
      /* 101-국가 ( 탭에 노출은 '해외' ) */
